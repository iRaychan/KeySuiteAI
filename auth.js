(() => {
  ...
  async function loadData(userAccess=null){
    ...
    return {
      ...
      fuel_price:Number(setting.fuel_price??2),fuel_base_price:Number(setting.fuel_base_price??2),baseplateCosting:baseplateCosting,customerPricing:null,customerPricingRows:normalizedCustomerRows,
