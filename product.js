(() => {
  ...
  function pageShown(id){if(id==='productChc'){renderSeries();renderModels();return}if(id==='productEs'){renderEs();return}if(id==='productGws'){renderGws();refreshCatalogue('GWS');return}if(id==='productKeyplc'){renderKeyplc();refreshCatalogue('KEYPLC')}}
  ...
  window.KeySuiteProduct={pageShown,render,refreshCatalogue};
})();
