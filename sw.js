/* KeySuite V4.12.26 Service Worker. */
const CACHE='keysuite-v41226';
const BOOTSTRAP='\n<script src="./v41200-bootstrap.js?v=41226"></script>\n';
const SHELL=[
  './','./index.html','./manifest.json','./keylargo-logo.png',
  './permissions.js','./applications.js','./app.js','./pricing.js','./quotation-references.js','./categories.js','./pricelist.js','./product.js','./manifold.js','./roles.js','./assembly.js','./motor.js','./coupling.js','./baseplate.js','./quotation-templates.js','./company-settings.js','./keyai.js','./auth.js','./v388-dashboard-keycore.js','./universe.js',
  ...
  './selector/index.html','./selector/product.html','./selector/favicon.png','./supabase/functions/shared-chc/chc-data.js','./supabase/functions/shared-chc/chc-selector-core.js','./selector/apple-touch-icon.png','./selector/bgreich-logo.png',
...
function isSelectorPath(path){return /\/(?:selector|selector-es)\//.test(path)}
